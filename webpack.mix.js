...
mixAssetsDir('vendor/calendar/**/*.js', (src, dest) => mix.copy(src, dest));
mixAssetsDir('vendor/calendar/**/*.css', (src, dest) => mix.copy(src, dest));
...
mix.js('resources/assets/js/laravel-user-management.js', 'public/assets/js/');
mix.js('resources/assets/js/app.js', 'public/assets/js/alpine.js');
