    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        ...
        <div class="mx-auto">
          ...
          <p>
            Logge dich in deinen Account ein <br> und hilf Menschen beim Geld sparen!
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="w-px-400 mx-auto">
        ...
        <div class="app-brand justify-content-center mb-4">
          <a href="{{url('/')}}" class="app-brand-link gap-2 mb-2">
            ...
            <span class="app-brand-text demo h3 mb-0 fw-bold">Energy Group CRM</span>
          </a>
        </div>
        <!-- /Logo -->
        <h4 class="mb-2">Willkommen bei Energy Group! 👋</h4>
        <p class="mb-4">Bitte logge dich in deinen Account ein um das Abenteuer zu starten!</p>
