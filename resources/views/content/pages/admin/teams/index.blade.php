...
<div class="container">
    <div class="d-flex justify-content-between align-items-center">
        <h2>Teams Liste</h2>
        <div class="btn-group">
            <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary me-2">Zurück zum Admin Panel</a>
    ...
    <table id="teams-table" class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Edit button -->
                    <a href="{{ route('admin.teams.edit', $team->id) }}" class="btn btn-sm btn-info">Bearbeiten</a>
                </td>
            </tr>
            @endforeach
        </tbody>
