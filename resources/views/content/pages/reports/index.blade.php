                     ...
                     <table id="" class="table table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{round($total['sumcommission'] ?? 0,2)}}</td>
                     ...
                     <table id="userTable" class="display">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{$team->count ?? 0}}</td>
                              <td>{{round($team->team_commission * 80 / 100 ?? 0,2)}}</td>
                              {{-- <td>{{0}}</td> --}}
                              <!-- Add other user data columns as needed -->
                           </tr>
                           @endforeach
                     ...
                     <table id="vertragTable" class="display">
                        ...
                        <tbody>
                           ...
                           <tr>
                             ...
                             @else
                             @if($user->user_stufe == '')
                             <td>{{round($user->user_commission * 80 / 100 * (.5),2) }}</td>
                             @elseif($user->user_stufe == 1)
                             <td>{{round($user->user_commission * 80 / 100 * (.67),2) }}</td>
                             @elseif($user->user_stufe == 2)
                             <td>{{round($user->user_commission * 80 / 100 * (.8),2) }}</td>
                             @elseif($user->user_stufe == 3)
                             <td>{{round($user->user_commission * 80 / 100 * (.91),2) }}</td>
                             @elseif($user->user_stufe == 4)
                             <td>{{round($user->user_commission * 80 / 100 * (1),2) }}</td>
                              @endif
                              @endif
